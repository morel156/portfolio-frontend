...
const allProjects = [
  {
    ...
    demoUrl: "#",
    githubUrl: "https://github.com/moreltech/stabilit",
    year: 2024,
    featured: true,
  ...
  {
    id: 2,
    title: "Ko'com — Refonte Site E-Commerce",
    slug: "kocom-ecommerce",
    category: "WordPress / WooCommerce",
    problem: "Site WordPress lent, mal référencé, avec une navigation confuse. Perte de 40% des conversions mobile.",
    solution: "Refonte complète du thème, optimisation des Core Web Vitals, restructuration SEO technique, implémentation d'une UX moderne.",
    impact: "Amélioration de 65% des performances. Augmentation de 35% du taux de conversion. +80% en trafic organique.",
    shortDesc: "E-commerce premium WordPress avec optimisation SEO et Core Web Vitals.",
    image: "/Accueil_partie1.png",
    technologies: ["wordpress", "react"],
    stack: ["WordPress", "WooCommerce", "PHP", "JavaScript", "Tailwind"],
    demoUrl: "https://kocom.bj",
    githubUrl: "#",
    year: 2024,
    featured: true,
    stats: { conversions: "+35%", performance: "65%", traffic: "+80%" }
  },
  {
    id: 3,
    title: "CRM Immobilier — Solution SaaS",
    slug: "crm-immobilier",
    category: "Full Stack SaaS",
    problem: "Les agents immobiliers perdaient 60% de leur temps sur de la gestion manuelle. Zéro suivi client, zéro pipeline.",
    solution: "Application SaaS end-to-end avec gestion des biens, suivi des clients, pipeline de ventes, documents automatisés et dashboards analytiques.",
    impact: "Gain de temps de 60% sur la gestion. 3 agences utilisant la plateforme activement.",
    shortDesc: "SaaS de gestion immobilière avec CRM, pipeline et documents automatisés.",
    image: "/Accueil_partie1.png",
    technologies: ["nextjs", "laravel", "mysql"],
    stack: ["Next.js 14", "Laravel 11", "MySQL", "TypeScript", "Tailwind CSS"],
    demoUrl: "#",
    githubUrl: "https://github.com/moreltech/crm-immobilier",
    year: 2024,
    featured: true,
    stats: { timeSaved: "60%", agencies: "3", documents: "Auto" }
  },
  {
    id: 4,
    ...
    problem: "Données métier dispersées dans Excel et Google Sheets. Aucune visibilité en temps réel. Décisions basées sur de vieilles données.",
    solution: "Dashboard centralisé avec intégration des données, visualisations interactives, alertes automatiques et rapports programmés.",
    impact: "Décisions 3x plus rapides. Insights en temps réel. ROI identifié en 2 semaines.",
    shortDesc: "Plateforme de visualisation données avec intégrations et alertes temps réel.",
    image: "/Accueil_partie1.png",
    technologies: ["nextjs", "python", "data"],
    stack: ["Next.js", "Python", "FastAPI", "PostgreSQL", "Chart.js"],
    demoUrl: "#",
    githubUrl: "#",
    year: 2024,
    featured: false,
    stats: { speed: "3x", insights: "Temps réel", roi: "2 semaines" }
  },
  {
    id: 5,
    title: "API REST Marketplace",
    slug: "api-marketplace",
    category: "Backend / Microservices",
    problem: "Besoin d'une API robuste et sécurisée pour supporter une marketplace avec paiements, notifications et webhooks complexes.",
    solution: "API REST Laravel avec Sanctum, gestion des paiements Stripe, système de webhooks, queues asynchrones et monitoring avec Sentry.",
    impact: "100% uptime sur 6 mois. +500K requêtes/jour. Response time <100ms.",
    shortDesc: "API REST ultra-performante pour marketplace avec paiements et webhooks.",
    image: "/Accueil_partie1.png",
    technologies: ["laravel", "nodejs", "mysql"],
    stack: ["Laravel 11", "Sanctum", "Stripe", "Redis", "Docker"],
    demoUrl: "#",
    githubUrl: "https://github.com/moreltech/marketplace-api",
    year: 2023,
    featured: false,
    stats: { uptime: "100%", requests: "500K/day", latency: "<100ms" }
  },
  {
    id: 6,
    title: "Prédiction ML — Market Forecasting",
    slug: "ml-prediction",
    category: "Data Engineering / AI",
    problem: "Prédire les tendances marché avec précision pour optimiser l'inventaire et les prix.",
    solution: "Modèles ML (Scikit-learn, XGBoost) entraînés sur 2 ans de données. Pipeline ETL automatisé, réentraînement hebdo, API de prédictions.",
    impact: "Précision de 87% sur 30 jours. Gain d'optimisation d'inventaire: 22%.",
    shortDesc: "Modèles ML de prédiction de tendances avec pipeline ETL automatisé.",
    image: "/Accueil_partie1.png",
    technologies: ["python", "data"],
    stack: ["Python", "Scikit-learn", "XGBoost", "Pandas", "PostgreSQL"],
    demoUrl: "#",
    githubUrl: "https://github.com/moreltech/market-ml",
    year: 2024,
    featured: false,
    stats: { accuracy: "87%", optimization: "+22%", retraining: "Weekly" }
  },
];
